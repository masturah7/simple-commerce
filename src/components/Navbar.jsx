      ...
      <nav className="flex w-[90%]  py-2 items-center gap-10 justify-between ">
        ...
        <Navbar.Collapse>
          <div className="flex-1 hidden sm:flex">
            <ul className="list-none flex  gap-4 md:gap-6 font-mukta text-[24px] md:text-[20px] text-customGray font-light">
              <li>Sales</li>
              <li>Hoodie</li>
              <li>Fashion</li>
              <li className="flex items-center">
                More <BiChevronDown /> <span className="ml-2"></span>
              </li>
            </ul>
          </div>
          ...
          <div className="flex gap-3 ">
            ...
            <article className="flex items-center border border-gray-300 rounded-lg h-[25px] w-[40] px-2 py-1">
              ...
              <span className="ml-1 font-mukta font-light text-sm text-customGray">
                0
              </span>
            </article>
            <div>
